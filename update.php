                ...
                <div class="container-signup">
                    ...
                    <div class="container-form">
                        <div class="con-box">
                            ...
                            <form action="editar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                <!-- nombre -->
                                    ...
                                    <div class="col-sm-12 box-ag">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" id="year" name="year" required>
                                                <option value="<?php echo $year; ?>" selected="1"  ><?php echo $year;?></option>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            value="<?php echo $descripcion; ?>" placeholder="Descripcion" required>
                                        </div>
                                        <div class="col-sm-12">
