...
<body>
    <div class="container-one" onload="time()">
        ...
        <section class="container-two">
            ...
            <h2 class="tittle-category">Busqueda</h2>
            ...
            if(!empty($word)){
                ...
                if($eso){
                    ...
                    $SELECT = "SELECT * FROM peliculas WHERE nombre LIKE '%".$word."%' ORDER BY id DESC";
                    $resultado = mysqli_query($conn,$SELECT);
                    if($resultado){
                        ?>
                        ...
                        if($row = $resultado->fetch_array()){
                            ...
                            ?>
                            <h2 class="nobus">No se han encontrado resultados para tu búsqueda</h2>
                            <?php
                        }
