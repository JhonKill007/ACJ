...
?>
        ...
        <div class="screen">
            <iframe src=<?php echo $_GET['link']; ?> frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

        </div>
        <h1 class="texto center"><?php echo $_GET['nombre']; ?></h1>
        <div class="container-info">
            
            <label class="texto center"><?php echo $_GET['categoria']; ?> / 2020</label>
            <p class="texto"><?php echo $_GET['descripcion']; ?></p>
